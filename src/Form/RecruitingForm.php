...
/**
 * Form controller for recruiting edit forms.
 *
...
class RecruitingForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created new %label recruiting.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved %label recruiting.', [
          '%label' => $entity->label(),
        ]));
    }
